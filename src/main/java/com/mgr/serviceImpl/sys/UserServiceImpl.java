package com.mgr.serviceImpl.sys;
...
@Service("UserService")
public class UserServiceImpl implements UserService, SysConstants,
		GameConstants {
	...
	@Override
	public ServiceResult<ArrayList<LiveHost>> getLiveHosts1(String type, int per) {
